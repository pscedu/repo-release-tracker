...
parser.add_argument(
    "--utilities",
    action="store_true",
    help="Show utility repos"
)

parser.add_argument(
    "--scientific",
    action="store_true",
    help="Show scientific (stem) repos"
)
...
if args.utilities and args.scientific:
    ...
    filtered_df = sorted_combined_df[sorted_combined_df["Category"].isin(["Utility", "Both"])]
elif args.scientific:
    title = "Scientific Repositories"
    filtered_df = sorted_combined_df[sorted_combined_df["Category"].isin(["STEM", "Both"])]
else:
    title = "All Repositories"
    filtered_df = sorted_combined_df
